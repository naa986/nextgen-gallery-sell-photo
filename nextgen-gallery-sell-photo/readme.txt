...
[NextGEN Gallery Sell Photo](https://noorsplugin.com/nextgen-gallery-sell-photo-plugin/) plugin allows you to create a Buy button for each NextGEN Gallery photo that a user can click to purchase.
...
For documentation please visit the [NextGEN Gallery Sell Photo](https://noorsplugin.com/nextgen-gallery-sell-photo-plugin/) plugin page.

= Recommended Reading =

* [NextGEN Gallery Sell Photo Documentation](https://noorsplugin.com/nextgen-gallery-sell-photo-plugin/)
...
1. Browse for the plugin file (nextgen-gallery-sell-photo.zip) on your computer
1. Click "Install Now" and then hit the activate button

== Frequently Asked Questions ==

= Can this plugin be used to sell photos of my NextGEN gallery? =

Yes.

== Screenshots ==

1. NextGEN E-commerce Photo Gallery
...
= 1.0.4 =
* Compatible with WordPess 4.8
* Updated all the permalinks

= 1.0.3 =
* Added translation option
* NextGEN Gallery Sell Photo is now compatible with WordPress 4.4

= 1.0.2 =
* NextGEN Gallery Sell Photo is now compatible with WordPress 4.3
